// ============================================
// FILE: public/sigme-universal-sw.js
...
self.addEventListener('message', async (event) => {
  ...
  if (type === 'SIGME_INIT') {
    console.log('[Sigme Universal SW] Received configuration');
...
async function handleSubscribe(event) {
  try {
    ...
    // ⭐ FIX: Properly extract keys from subscription
    ...
    const apiUrl = websiteConfig.apiUrl || self.env?.NEXT_PUBLIC_BACKEND_URL || 'http://localhost:3000';
