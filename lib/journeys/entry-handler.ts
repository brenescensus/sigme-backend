...
//         // Skip if trigger doesn't match event
//         if (entryTrigger.type === 'event' && entryTrigger.event_name !== event.event_name) {
//           console.log(`[JourneyEntry] Skipping ${journey.name} - trigger is "${entryTrigger.event_name}", not "${event.event_name}"`);
//           continue;
//         }
