...
// //     const triggerNode = journey.flow_definition.nodes.find((n: FlowNode) => n.type === 'trigger');
// //     if (!triggerNode) return;

// //     const firstEdge = journey.flow_definition.edges.find((e: FlowEdge) => e.source === triggerNode.id);
// //     if (!firstEdge) return;
...
// //         journey_id: journey.id,
// //         event_data: { node_id: node.id, title: payload.title }
// //       });
