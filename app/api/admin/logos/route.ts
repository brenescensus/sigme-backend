...
// // File: app/api/admin/logos/route.ts
// // ============================================================================
...
// ============================================================================
// COMPANY LOGOS - ADMIN ROUTES (Collection Operations)
// File: app/api/admin/logos/route.ts
// ============================================================================
...
/**
 * GET /api/admin/logos
 * Get all company logos (admin only)
 * Query params: ?category=client|partner|integration
 */
export const GET = withAdmin(
